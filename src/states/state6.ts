...
// State 6 - Digital Dioramas (guided mode only, otherwise behaves like state 4)
export const state6Config: StateConfig = {
  header: {
  ...
  canvas: {
    clickable: true,
    nextState: 'state_7', // In free mode goes to final, in guided mode logic overrides to state_7
    previousState: 'state_5',
    fullscreen: true,
